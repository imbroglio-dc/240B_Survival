...
```{r time_to_return_moss}
knitr::include_graphics('MOSS_return_plot.png')
```

## Lost To Follow Up -- MOSS Estimate
```{r lost_to_follow_up_moss}
knitr::include_graphics('MOSS_reloss_plot.png')
```

## Results
- We find no effect of follow up tracing on return to care in this population
- We also find no effect of follow up tracing on remaining in care amongst those that do return to care at some point during the study

## Limitations
- The purpose of the tracing intervention was for information gathering rather than influencing a behavioral change
- Our adjustment set has been heavily reduced due to computational burden
- To consider our second question in a causal sense, we require treatment to be independent of return

## Conclusion
- Thank you to Wilson Cai for his development of the MOSS package, Mark and Rachel for facilitating this course, and Elvin Geng et. al. for providing the data used
