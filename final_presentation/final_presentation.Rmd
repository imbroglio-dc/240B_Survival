...
- $d(W)$ is fixed to 1 or 0, reflecting the treatment specific survival curve of everyone receiving treatment vs. no one receiving treatment. 
...
## Plug-in Estimation
\begin{align*}
    \Psi(Q_{W,n}, \lambda^*_n) = \frac{1}{n}\sum_{i = 1}^n S_{\lambda^*_n}(t_0 | A = d(W), W)
\end{align*}
